...
curl  http://www.ijg.org/files/jpegsrc.v9d.tar.gz -o jpegsrc.v9d.tar.gz
...
curl  -L https://curl.haxx.se/download/curl-7.68.0.tar.gz -o curl-7.68.0.tar.gz
...
curl  -L "https://www.hdfgroup.org/package/hdf5-1-10-6-tar-gz/?wpdmdl=14135&refresh=5e5f47f69f23f1583302646" -o hdf5-1.10.6.tar.gz
tar -xzf hdf5-1.10.6.tar.gz

curl  https://www.unidata.ucar.edu/downloads/netcdf/ftp/netcdf-c-4.7.3.tar.gz -o netcdf-c-4.7.3.tar.gz
tar -xzf netcdf-c-4.7.3.tar.gz

curl  https://www.unidata.ucar.edu/downloads/netcdf/ftp/netcdf-fortran-4.5.2.tar.gz -o netcdf-fortran-4.5.2.tar.gz
